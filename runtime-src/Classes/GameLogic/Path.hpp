...
typedef std::function<void(three::extras::Curve *)> PathChangeCurveFunc;
...
public:
	...
	void setPathListener(const PathChangeCurveFunc& lis){
		curveChangeListener = lis;
	}
...
private:
	...
	PathChangeCurveFunc curveChangeListener;
	three::extras::Curve* currentCurve = NULL;
    float length;
};
